    ...
    IGithubReleaseHelper
{
    ...
    static readonly string[] ProjectsToPack = [Projects.Invex_SemanticVersion.Name];

    static readonly string[] ProjectsToTest = [Projects.Invex_SemanticVersion_Tests.Name];
